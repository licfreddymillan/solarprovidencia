    ...
    <div class="table-responsive">
        <table class="table data-thumb-view">
            ...
            <tbody>
                ...
                <tr>
                    <td class="product-name">{{ date('d-m-Y', strtotime($clase->ending_date)) }}</td>
                    <td class="product-category">{{ $clase->user->name }}</td>
                    <td class="product-category">{{ $clase->course->title }}</td>
                    <td class="product-action">
                        <span style="font-size: 30px;"><a href="{{ route('admin.finalize-class', [$clase->id]) }}" title="Clase Finalizada"><i class="feather icon-check-circle"></i></a></span>
                    </td>
                </tr>
                @endforeach
            </tbody>
