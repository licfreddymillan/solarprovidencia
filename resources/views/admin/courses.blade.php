...
@section('content')
    @if (Session::has('store-msj'))
        <script>
            $(document).ready(function () {
                toastr.success('El curso ha sido creado con éxito', { "closeButton": true });
            });
        </script>
    @endif
    @if (Session::has('update-msj'))
        <script>
            $(document).ready(function () {
                toastr.success('El curso ha sido modificado con éxito', { "closeButton": true });
            });
        </script>
    @endif
    @if (Session::has('delete-msj'))
        <script>
            $(document).ready(function () {
                toastr.success('El curso ha sido eliminado con éxito', { "closeButton": true });
            });
        </script>
    @endif
<section id="data-thumb-view" class="data-thumb-view-header">
    ...
    <div class="add-new-data-sidebar">
        ...
        <div class="add-new-data">
            ...
            <div id="edit-course" style="display: none;">
