            ...
            <table class="table data-thumb-view">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div @if ($transferencia->status == 1) class="chip chip-success" @else class="chip chip-danger" @endif>
                                <div class="chip-body">
                                    <div class="chip-text">@if ($transferencia->status == 1) Aprobada @else Rechazada @endif</div>
                                </div>
                            </div>
                        </td>
                    </tr>
